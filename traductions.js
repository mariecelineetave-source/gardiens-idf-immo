/* =====================================================================
   gardiens.idf.immo — traduction du formulaire de partage
   ...
   elle qui le lit. Seul l'accusé de réception part dans la langue du gardien.
   ===================================================================== */
(function () {
  "use strict";
  ...
  const T = {
    pt: {
      ...
      "La résidence dont vous êtes gardien": "O prédio de que é porteiro",
      ...
      "« Je connais une conseillère immobilière sérieuse, qui travaille dans le secteur. Si votre projet se précise, je peux lui donner votre numéro pour qu'elle vous appelle ? »":
      ...
      "« C'est Martine, la gardienne de votre résidence, qui m'a donné votre numéro, avec votre accord. »":
        "« Foi a Martine, a porteira do seu prédio, que me deu o seu número, com a sua autorização. »",
      "Non, ne me citez pas": "Não, não digam o meu nome",
      "« J'ai eu votre numéro par une personne de votre résidence, qui m'a dit que vous étiez d'accord pour que je vous appelle. » Votre nom n'est jamais prononcé.":
        "« Recebi o seu número de uma pessoa do seu prédio, que me disse que estava de acordo em que eu lhe telefonasse. » O seu nome nunca é dito.",
      ...
      "Martine": "Maria", "M. Bernard": "Sr. Bernardo",
      "Résidence des Tilleuls, Antony": "Residência das Tílias, Antony",
      "Ils partent en province à la retraite, ils en ont parlé en juin.":
        "Vão para a província na reforma, falaram nisso em junho.",
      "martine@exemple.fr": "maria@exemplo.pt"
    },
    ...
    en: {
      ...
      "La résidence dont vous êtes gardien": "The building you look after",
      ...
      "« C'est Martine, la gardienne de votre résidence, qui m'a donné votre numéro, avec votre accord. »":
        "“Martine, the caretaker of your building, gave me your number, with your permission.”",
      "Non, ne me citez pas": "No, don't name me",
      "« J'ai eu votre numéro par une personne de votre résidence, qui m'a dit que vous étiez d'accord pour que je vous appelle. » Votre nom n'est jamais prononcé.":
        "“I was given your number by someone in your building, who told me you were happy for me to call.” Your name is never spoken.",
      ...
      "M. Bernard": "Mr Bernard",
      "Résidence des Tilleuls, Antony": "Lime Tree Court, Antony",
      "Ils partent en province à la retraite, ils en ont parlé en juin.":
        "They're retiring to the countryside, they mentioned it in June.",
      "martine@exemple.fr": "martine@example.com"
    }
  };

  const TITRES = {
    pt: "Partilhar uma oportunidade — gardiens.idf.immo",
    en: "Share an opportunity — gardiens.idf.immo"
  };
  ...
  /* L'accusé de réception, dans la langue du gardien. */
  window.CONFIRMATION = {
    pt: (v) =>
